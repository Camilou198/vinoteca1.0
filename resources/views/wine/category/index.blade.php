                            ...
                            @foreach($categories as $category)
                                <div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 relative">
                                    ...
                                    <div class="flex flex-col p-4 leading-normal">
                                        <h5 class="mb-2 text-2xl font-bold tracking-tigth text-gray-900 dark:text-white">{{ $category->name }}
                                        ...
                                        <div class="absolute bottom-0 right p-4 flex justify-between">
                                            <a
                                                href="{{ route('categories.edit', $category) }}"
                                                class="bg-purple-500 hover:pg-purple-700 text-white font-bold p-1 rounded mb-2 md:mb-0 text-center"
                                            >
                                                Editar
                                            </a>
                                            <form action="{{ route('categories.destroy', $category) }}" method="POST">
                                                ...
                                                <button
                                                    type="submit"
                                                    class="bg-red-500 hover:bg-red-700 text-white font-bold p-1 rouned w-full md:w-auto ms-2"
                                                >
                                                    Eliminar
                                                </button>
                                            </form>
